...
![coverage](https://img.shields.io/badge/coverage-67.7%25%20instructions-yellowgreen)

Coverage: **67.7%** instructions · **63.3%** branches · **69.2%** lines across 40 modules (JaCoCo; full per-module report in CI artifacts).

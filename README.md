...
![coverage](https://img.shields.io/badge/coverage-66.5%25%20instructions-yellowgreen)

Coverage: **66.5%** instructions · **60.4%** branches · **67.5%** lines across 38 modules (JaCoCo; full per-module report in CI artifacts).

...
![coverage](https://img.shields.io/badge/coverage-70.9%25%20instructions-green)

Coverage: **70.9%** instructions · **60.1%** branches · **69.9%** lines across 38 modules (JaCoCo; full per-module report in CI artifacts).

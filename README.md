...
![coverage](https://img.shields.io/badge/coverage-71.0%25%20instructions-green)

Coverage: **71.0%** instructions · **60.3%** branches · **70.0%** lines across 37 modules (JaCoCo; full per-module report in CI artifacts).

...
![coverage](https://img.shields.io/badge/coverage-66.4%25%20instructions-yellowgreen)

Coverage: **66.4%** instructions · **55.4%** branches · **65.4%** lines across 38 modules (JaCoCo; full per-module report in CI artifacts).

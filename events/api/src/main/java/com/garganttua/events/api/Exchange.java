...
// EI_EXPOSE: copy-on-write transport record — the with*(...) methods deliberately share
// the value/headers/steps/properties references with the new instance for unchanged
// fields (and components may be null by design); a defensive copy would break that
// sharing and the null contract relied on by the routing/expression layers.

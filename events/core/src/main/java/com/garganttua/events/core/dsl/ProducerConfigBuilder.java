...
// Fluent DSL: builder method names (destinationPolicy(), destinationUuid()) deliberately mirror the
// fields they set; the method names are the public IProducerConfigBuilder contract and cannot change.

 ...
 * reads their {@code value} member, regardless of declaring package. This module does not depend
 * on the official {@code spotbugs-annotations} artifact, so this {@code CLASS}-retained annotation

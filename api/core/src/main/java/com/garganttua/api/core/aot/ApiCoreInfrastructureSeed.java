...
public class ApiCoreInfrastructureSeed implements IAOTInfrastructureSeed {
    ...
    public void seed(IAOTSeedContext context) {
        ...
        registerServicePrimitives(context);
        registerExpressions(context);
    }

    private static void registerContexts(IAOTSeedContext context) {
    ...
    private static void registerDefinitions(IAOTSeedContext context) {
    ...
    private static void registerServicePrimitives(IAOTSeedContext context) {
    ...
    private static void registerExpressions(IAOTSeedContext context) {

...
public class SerializationExpressions {
	...
	public static byte[] serialize(@Nullable Object serializer, @Nullable Object object) {
		ISerializer ser = (ISerializer) unwrapOptional(serializer);
		if (ser == null) {
	...
	public static String serializerContentType(@Nullable Object serializer) {
		ISerializer ser = (ISerializer) unwrapOptional(serializer);
		if (ser == null) {
	...
	@SuppressFBWarnings(value = "PZLA_PREFER_ZERO_LENGTH_ARRAYS",
			justification = "null signals 'no bytes supplied' (distinct from an empty payload); the caller "
					+ "checks data == null to raise a precise error.")

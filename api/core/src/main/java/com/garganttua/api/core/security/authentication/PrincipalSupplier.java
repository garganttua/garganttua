...
public class PrincipalSupplier implements IContextualSupplier<Object, IRuntimeContext> {
    ...
    public Optional<Object> supply(IRuntimeContext context, Object... otherContexts) throws SupplyException {
        ...
        Object principal = findPrincipal(request, domainContext, domDef, authDef, authRequest.login());
    ...
    private Object findPrincipal(IOperationRequest request, IDomain<?> domainContext,
            DomainDefinition<?> domDef, IAuthenticatorDefinition authDef, String login) throws SupplyException {

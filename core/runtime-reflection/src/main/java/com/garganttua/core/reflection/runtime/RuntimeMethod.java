...
public class RuntimeMethod implements IMethod {
	...
	private static final Map<Method, RuntimeMethod> CACHE = new ConcurrentHashMap<>();
	...
	@SuppressFBWarnings(value = "EI_EXPOSE_REP",
			justification = "unwrap() deliberately exposes the wrapped JDK Method; that is its contract")
	...
	@SuppressFBWarnings(value = "MS_EXPOSE_REP",
			justification = "unwrap(IMethod) deliberately exposes the wrapped JDK Method; that is its contract")
	...
	@Override
	// justification: mirrors AccessibleObject.setAccessible as required by the IMethod contract

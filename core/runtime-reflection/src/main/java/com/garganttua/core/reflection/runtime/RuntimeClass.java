 ...
 */
// justification: "unchecked" recurs only inside @SuppressWarnings on the many mandatory
// generic-cast accessor overrides of this IClass mirror; it is not a duplicatable domain literal
@SuppressWarnings("PMD.AvoidDuplicateLiterals")
public class RuntimeClass<T> implements IClass<T> {

	private static final Map<Class<?>, RuntimeClass<?>> CACHE = new ConcurrentHashMap<>();
	...
	@Override
	// justification: mirrors Class.getRecordComponents — null means "not a record",
	// distinct from an empty array (record with no components); must preserve JDK semantics
	@SuppressWarnings("PMD.ReturnEmptyCollectionRatherThanNull")
	@SuppressFBWarnings(value = "PZLA_PREFER_ZERO_LENGTH_ARRAYS",
			justification = "null vs empty is a meaningful JDK distinction: null == not a record")
	...
	@Override
	// justification: mirrors Class.getPermittedSubclasses — null means "not sealed",
	// distinct from an empty array; must preserve JDK semantics
	@SuppressWarnings("PMD.ReturnEmptyCollectionRatherThanNull")
	@SuppressFBWarnings(value = "PZLA_PREFER_ZERO_LENGTH_ARRAYS",
			justification = "null vs empty is a meaningful JDK distinction: null == not sealed")
	...
	@Override
	// justification: mirrors Class.getClassLoader for the wrapped type; the thread-context
	// loader is deliberately NOT wanted here — this returns the wrapped class's own loader
	...
	@SuppressFBWarnings(value = "EQ_CHECK_FOR_OPERAND_NOT_COMPATIBLE_WITH_THIS",
			justification = "accepting raw Class<?> is a documented (deprecated) backward-compat path; see javadoc")
	 ...
	 *         is {@code null}
	 */
	// justification: array param kept (not varargs) to preserve the public static API signature other modules call

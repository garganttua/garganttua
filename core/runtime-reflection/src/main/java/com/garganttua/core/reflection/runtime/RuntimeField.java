...
public class RuntimeField implements IField {
	...
	private static final Map<Field, RuntimeField> CACHE = new ConcurrentHashMap<>();
	 ...
	 */
	// EI_EXPOSE_REP: exposing the wrapped JDK Field is the documented contract of unwrap().
	@SuppressFBWarnings(value = "EI_EXPOSE_REP", justification = "unwrap() intentionally returns the wrapped JDK field")
	public Field unwrap() {
		return field;
	}
	 ...
	 */
	// MS_EXPOSE_REP: returning the wrapped JDK field is the documented contract of unwrap().
	@SuppressFBWarnings(value = "MS_EXPOSE_REP", justification = "unwrap() intentionally returns the wrapped JDK field")

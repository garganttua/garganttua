...
public class ConsoleExecutionContext {
    ...
    public static class ConsoleContext {
        ...
        /** SpotBugs pattern shared by the exposed-representation getter suppressions. */
        private static final String EI_REP = "EI_EXPOSE_REP";
        /** Shared justification for the design-intentional exposed-representation suppressions. */
        private static final String EI_REP_JUSTIFICATION =
                "Shared session map and I/O singletons are exposed by design.";
         ...
         */
        // EI_EXPOSE_REP2: the session map is deliberately a live shared reference; terminal/line-reader
        // are JLine I/O singletons that must not be copied. Sharing is the design contract.
        @SuppressFBWarnings(value = "EI_EXPOSE_REP2", justification = "Live shared session map and JLine I/O singletons are shared by design, not copied.")
        public ConsoleContext(Map<String, Object> sessionVariables, IExpressionContext expressionContext,
        ...
        // EI_EXPOSE_REP: returning the live shared map is the intended contract (console functions mutate it).
        @SuppressFBWarnings(value = EI_REP, justification = EI_REP_JUSTIFICATION)
        ...
        // EI_EXPOSE_REP: the I/O stream is a shared singleton, not copyable state.
        @SuppressFBWarnings(value = EI_REP, justification = EI_REP_JUSTIFICATION)
        ...
        // EI_EXPOSE_REP: the JLine terminal is a shared I/O singleton, not copyable state.
        @SuppressFBWarnings(value = EI_REP, justification = EI_REP_JUSTIFICATION)
        ...
        // EI_EXPOSE_REP: the JLine line reader is a shared I/O singleton, not copyable state.
        @SuppressFBWarnings(value = EI_REP, justification = EI_REP_JUSTIFICATION)

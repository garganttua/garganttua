...
final class ConsoleContextFactory {
    ...
    private static IReflectionBuilder buildReflectionBuilder(boolean useAOT) {
        try {
            ...
            throw new IllegalStateException("Failed to initialize reflection provider", e);
        }
    }
    ...
    static BuiltContexts build(boolean useAOT) {
        ...
        IReflectionBuilder reflectionBuilder = buildReflectionBuilder(useAOT);

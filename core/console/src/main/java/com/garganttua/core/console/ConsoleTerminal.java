...
final class ConsoleTerminal {
    ...
    // AvoidFieldNameMatchingMethodName: package-private accessors deliberately mirror these field
    // names (terminal()/lineReader()/completer()) — the intended accessor design for this owner.

...
public interface IInvocationResult<R> extends ISupplier<R> {
     ...
     */
    // THROWS_CLAUSE_THROWABLE: rethrow() faithfully re-raises the captured Throwable, whatever
    // its declared type — narrowing the throws clause would defeat the purpose.
    @SuppressFBWarnings(value = "THROWS_METHOD_THROWS_CLAUSE_THROWABLE",
            justification = "faithfully rethrows the captured Throwable")
     ...
     */
    // THROWS_RUNTIMEEXCEPTION: rethrowUnchecked() intentionally surfaces the failure unchecked.
    @SuppressFBWarnings(value = "THROWS_METHOD_THROWS_RUNTIMEEXCEPTION",
            justification = "intentional unchecked rethrow")

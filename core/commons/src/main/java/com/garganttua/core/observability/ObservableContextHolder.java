 ...
 * @since 2.0.0-ALPHA02
 */
// current() accessor intentionally mirrors the CURRENT thread-local field
...
public final class ObservableContextHolder {
	 ...
	 * the current thread.
	 */
	// EI_EXPOSE: the registry is a live shared sink held by identity for the duration of the
	// session; copying it would break event routing.
	@SuppressFBWarnings(value = "EI_EXPOSE_REP",
			justification = "live shared registry held by identity")

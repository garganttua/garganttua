 ...
 */
// EI_EXPOSE: a Throwable cannot be meaningfully defensively copied; the captured exception is
// carried by reference as an immutable-by-convention diagnostic record.
@SuppressFBWarnings(value = "EI_EXPOSE_REP",
        justification = "Throwable carried by reference; not defensively copyable")

 ...
 * <li><b>sourceRules</b>: Mapping rules applied when mapping from source to
 * destination</li>
 * <li><b>destinationRules</b>: Mapping rules applied when mapping from
 * destination to source (reverse mapping)</li>
 * <li><b>mappingDirection</b>: Indicates whether this is a regular or reverse
 * mapping</li>
 * </ul>
 *
 * <h2>Usage Example:</h2>
...
public record MappingConfiguration(
	...
	/**
	 * Canonical constructor making defensive immutable copies of the rule lists.
	 */
	// null preserves the "unset" rule list; non-null is defensively copied
	@SuppressWarnings("PMD.NullAssignment")
	public MappingConfiguration {
		sourceRules = sourceRules == null ? null
				: Collections.unmodifiableList(new ArrayList<>(sourceRules));
		destinationRules = destinationRules == null ? null
				: Collections.unmodifiableList(new ArrayList<>(destinationRules));
	}

...
public class FixedElementResolver implements IElementResolver {
    ...
    public static <T> T getFixedValue(Fixed annotation, IClass<T> targetType) throws DiException {
        ...
        if ("int".equals(typeName) || typeName.equals(Integer.class.getName())) {
            value = annotation.valueInt();
        } else if ("double".equals(typeName) || typeName.equals(Double.class.getName())) {
            value = annotation.valueDouble();
        } else if ("float".equals(typeName) || typeName.equals(Float.class.getName())) {
            value = annotation.valueFloat();
        } else if ("long".equals(typeName) || typeName.equals(Long.class.getName())) {
            value = annotation.valueLong();
        } else if (typeName.equals(String.class.getName())) {
            value = annotation.valueString();
        } else if ("byte".equals(typeName) || typeName.equals(Byte.class.getName())) {
            value = annotation.valueByte();
        } else if ("short".equals(typeName) || typeName.equals(Short.class.getName())) {
            value = annotation.valueShort();
        } else if ("boolean".equals(typeName) || typeName.equals(Boolean.class.getName())) {
            value = annotation.valueBoolean();
        } else if ("char".equals(typeName) || typeName.equals(Character.class.getName())) {

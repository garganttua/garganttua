...
public class GreaterCondition<T> implements ICondition {
    ...
    /** Expression function name registered for the greater-than comparison. */
    private static final String EXPRESSION_NAME = "greater";
     ...
     */
    @Expression(name = EXPRESSION_NAME, description = "Checks if first argument is greater than second")
     ...
     * @return {@code true} when {@code a > b}
     */
    @Expression(name = EXPRESSION_NAME, description = "Checks if first int argument is greater than second int")
     ...
     * @return {@code true} when {@code a > b}
     */
    @Expression(name = EXPRESSION_NAME, description = "Checks if first long argument is greater than second long")
     ...
     * @return {@code true} when {@code a > b}
     */
    @Expression(name = EXPRESSION_NAME, description = "Checks if first double argument is greater than second double")
     ...
     * @return {@code true} when {@code a > b}
     */
    @Expression(name = EXPRESSION_NAME, description = "Checks if first Object argument is greater than second int")
     ...
     * @return {@code true} when {@code a > b}
     */
    @Expression(name = EXPRESSION_NAME, description = "Checks if first int argument is greater than second Object")

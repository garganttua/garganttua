...
public class LowerCondition<T> implements ICondition {
    ...
    /** Expression function name registered for the lower-than comparison. */
    private static final String EXPRESSION_NAME = "lower";
     ...
     */
    @Expression(name = EXPRESSION_NAME, description = "Checks if first argument is lower than second")
     ...
     * @return {@code true} when {@code a < b}
     */
    @Expression(name = EXPRESSION_NAME, description = "Checks if first int argument is lower than second int")
     ...
     * @return {@code true} when {@code a < b}
     */
    @Expression(name = EXPRESSION_NAME, description = "Checks if first long argument is lower than second long")
     ...
     * @return {@code true} when {@code a < b}
     */
    @Expression(name = EXPRESSION_NAME, description = "Checks if first double argument is lower than second double")
     ...
     * @return {@code true} when {@code a < b}
     */
    @Expression(name = EXPRESSION_NAME, description = "Checks if first Object argument is lower than second int")
     ...
     * @return {@code true} when {@code a < b}
     */
    @Expression(name = EXPRESSION_NAME, description = "Checks if first int argument is lower than second Object")

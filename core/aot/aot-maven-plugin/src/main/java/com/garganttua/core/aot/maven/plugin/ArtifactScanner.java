...
final class ArtifactScanner {
            ...
            try (JarFile jar = new JarFile(artifact.getFile())) {
                ...
                while (entries.hasMoreElements()) {
                    ...
                    try (BufferedReader reader = new BufferedReader(
                        ...
                        collectNonBlankLines(reader, lines);
                    }
                }
            } catch (IOException e) {
                // Skip unreadable JARs — they may be directories or non-standard artifacts.
                // Best-effort scan: a single bad JAR must not abort aggregation.
                continue;
            }
        }
    ...
    /**
     * Reads every non-blank line from {@code reader}, trims it, and adds it to
     * {@code target}.
     *
     * @param reader the reader to drain
     * @param target the collection receiving trimmed, non-blank lines
     * @throws IOException if reading fails
     */
    static void collectNonBlankLines(BufferedReader reader, Set<String> target) throws IOException {

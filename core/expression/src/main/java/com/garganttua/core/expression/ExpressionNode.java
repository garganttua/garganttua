...
public class ExpressionNode<R> implements IExpressionNode<R, ISupplier<R>> {
    ...
    public ISupplier<R> evaluate() throws ExpressionException {
        Object[] params = evaluateChildParams();
    ...
    private Object[] evaluateChildParams() throws ExpressionException {
    ...
    private ISupplier<R> wrapForDynamicReturnType(ISupplier<R> original) {

...
public class ExpressionNodeFactoryBuilder<S>
     ...
     */
    // CT_CONSTRUCTOR_THROW: builder validation legitimately reports failures via DslException; class is not subclassed.
    @SuppressFBWarnings(value = "CT_CONSTRUCTOR_THROW",
            justification = "Builder constructor must signal owner-query failure; no finalizer-attack surface (no subclasses).")

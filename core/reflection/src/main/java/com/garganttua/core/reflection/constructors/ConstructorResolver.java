 ...
 */
// PMD.AvoidLiteralsInIfCondition: idiomatic constructor-count comparisons against 1 (unique / multiple match)
@SuppressWarnings("PMD.AvoidLiteralsInIfCondition")
public class ConstructorResolver {
    private static final Logger log = Logger.getLogger(ConstructorResolver.class);

    private static final String OWNER_TYPE_NULL_MSG = "Owner type cannot be null";
    private static final String PROVIDER_NULL_MSG = "Reflection provider cannot be null";
    ...
    public static <T> ResolvedConstructor<T> defaultConstructor(IClass<T> ownerType,
        ...
        Objects.requireNonNull(ownerType, OWNER_TYPE_NULL_MSG);
        Objects.requireNonNull(provider, PROVIDER_NULL_MSG);

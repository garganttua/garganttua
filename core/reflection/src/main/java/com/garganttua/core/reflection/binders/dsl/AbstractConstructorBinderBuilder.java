...
public abstract class AbstractConstructorBinderBuilder<Constructed, Builder extends IConstructorBinderBuilder<Constructed, Builder, Link, IConstructorBinder<Constructed>>, Link>
    ...
    private static final Logger log = Logger.getLogger(AbstractConstructorBinderBuilder.class);

    private static final String NO_NAME_BINDING_MSG = "Parameter name-based binding is not supported for constructors";
    ...
    public Builder withParam(String paramName, Object parameter) throws DslException {
        throw new DslException(NO_NAME_BINDING_MSG);
    }
    ...
    public IConstructorBinder<Constructed> doBuild() throws DslException {
        ...
        try {
            ...
            return buildParameterizedBinder(reflection);
    ...
    private IConstructorBinder<Constructed> buildParameterizedBinder(IReflection reflection)
            throws DslException, ReflectionException {

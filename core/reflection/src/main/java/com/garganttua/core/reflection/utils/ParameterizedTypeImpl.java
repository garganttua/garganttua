 ...
 */
// UseVarargs: mirrors java.lang.reflect.ParameterizedType.getActualTypeArguments() Type[] contract; varargs would be inconsistent with the 3-arg ctor
...
public class ParameterizedTypeImpl implements ParameterizedType {
    ...
    public ParameterizedTypeImpl(Type rawType, Type[] typeArguments, Type ownerType) {
        ...
        this.typeArguments = typeArguments == null ? new Type[0] : typeArguments.clone();

 ...
 */
// PMD.AvoidDuplicateLiterals: the repeated "unchecked" literal is the standard generic-cast warning suppression
@SuppressWarnings("PMD.AvoidDuplicateLiterals")
public final class ContextualFieldBinder<OnwerType, FieldType, OwnerContextType, FieldContextType>

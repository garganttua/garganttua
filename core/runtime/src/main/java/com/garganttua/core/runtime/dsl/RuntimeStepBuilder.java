...
public class RuntimeStepBuilder<ExecutionReturn, StepObjectType, InputType, OutputType>
    ...
    @SuppressFBWarnings(value = "EI_EXPOSE_REP",
            justification = "Fluent DSL: returns the live child method builder so callers continue configuring the same step.")
    ...
    @Override
    @SuppressFBWarnings(value = "EI_EXPOSE_REP",
            justification = "Fluent DSL: returns the live child fallback builder so callers continue configuring the same step.")

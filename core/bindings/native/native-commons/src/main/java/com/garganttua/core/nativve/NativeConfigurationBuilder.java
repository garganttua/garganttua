 ...
 */
// Fluent-DSL builder: the mode/resourcesPath/reflectionPath/configNamespace fields intentionally
// share their setter names (public builder API) — AvoidFieldNameMatchingMethodName is by design here.
...
public class NativeConfigurationBuilder
    ...
    // Descriptive collection name that happens to match the declaring builder type name.
    @SuppressWarnings("PMD.AvoidFieldNameMatchingTypeName")
    private final Set<INativeBuilder<?, ?>> nativeConfigurationBuilder = new HashSet<>();

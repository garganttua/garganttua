...
| Module | Description |
|:--|:--|
| [**core**](././README.md) | Garganttua Core - Foundational Java framework for dependency injection, workflow orchestration, reflection utilities, and more. |
...
|:--|:--|:--|
| **Java 25** | 25 | Modern Java with records, pattern matching, sealed types, and stable scoped values |

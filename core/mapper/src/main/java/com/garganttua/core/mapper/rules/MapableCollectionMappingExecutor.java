 ...
 */
// rawtypes: raw IClass<Collection> / IClass<Map> descriptors are intentional for the generic
// collection-instantiation lookup; consolidated here to avoid the duplicate-literal warning.

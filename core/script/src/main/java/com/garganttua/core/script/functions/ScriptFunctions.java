...
public class ScriptFunctions {
    ...
    /** Rendering used when a value is {@code null}. */
    private static final String NULL_STR = "null";
    /** Public DSL name of the included-script execution function family. */
    private static final String FN_EXECUTE_SCRIPT = "execute_script";
    ...
    public static String print(@Nullable Object value) {
        String str = value == null ? NULL_STR : value.toString();
    ...
    public static String print(@Nullable String value1, int value2) {
        String s1 = value1 == null ? NULL_STR : value1;
    ...
    private static void includeJar(ScriptContext ctx, String path) {
        ...
        } catch (RuntimeException e) { // ClassLoaderException is unchecked
            throw includeFailure("include: failed to load JAR: " + path, e);
        }
    }

    /** Builds an {@link ExpressionException} that preserves the original cause's stack trace. */
    private static ExpressionException includeFailure(String message, Throwable cause) {
    ...
    private static String includeScript(ScriptContext ctx, String path) {
        try {
            ...
            throw includeFailure("include: failed to load script: " + path, e);
        }
    }
    ...
    private static String includeClasspathScript(ScriptContext ctx, String resource) {
        try {
            ...
            throw includeFailure("include: failed to load classpath script: " + resource, e);
        }
    }
     ...
     *                             or no script is registered under {@code name}
     */
    @Expression(name = FN_EXECUTE_SCRIPT, description = "Executes an included script with no arguments")
     ...
     * @return the script's exit code
     */
    @Expression(name = FN_EXECUTE_SCRIPT, description = "Executes an included script with 1 argument")
    public static int executeScript(@Nullable Object name, @Nullable Object arg0) {
        return executeScriptImpl(name, arg0);
    }

    /** Executes an included script with 2 positional args ({@code @0}..{@code @1}); returns its exit code. */
    @Expression(name = FN_EXECUTE_SCRIPT, description = "Executes an included script with 2 arguments")
    ...
    /** Executes an included script with 3 positional args ({@code @0}..{@code @2}); returns its exit code. */
    @Expression(name = FN_EXECUTE_SCRIPT, description = "Executes an included script with 3 arguments")
    public static int executeScript(@Nullable Object name, @Nullable Object arg0, @Nullable Object arg1,
            @Nullable Object arg2) {
        return executeScriptImpl(name, arg0, arg1, arg2);
    }

    /** Executes an included script with 4 positional args ({@code @0}..{@code @3}); returns its exit code. */
    @Expression(name = FN_EXECUTE_SCRIPT, description = "Executes an included script with 4 arguments")
    public static int executeScript(@Nullable Object name, @Nullable Object arg0, @Nullable Object arg1,
            @Nullable Object arg2, @Nullable Object arg3) {
        return executeScriptImpl(name, arg0, arg1, arg2, arg3);
    }

    /** Executes an included script with 5 positional args ({@code @0}..{@code @4}); returns its exit code. */
    @Expression(name = FN_EXECUTE_SCRIPT, description = "Executes an included script with 5 arguments")
    public static int executeScript(@Nullable Object name, @Nullable Object arg0, @Nullable Object arg1,
            @Nullable Object arg2, @Nullable Object arg3, @Nullable Object arg4) {
        return executeScriptImpl(name, arg0, arg1, arg2, arg3, arg4);
    }

    /** Executes an included script with 6 positional args ({@code @0}..{@code @5}); returns its exit code. */
    @Expression(name = FN_EXECUTE_SCRIPT, description = "Executes an included script with 6 arguments")
    public static int executeScript(@Nullable Object name, @Nullable Object arg0, @Nullable Object arg1,
    ...
    /** Executes an included script with 7 positional args ({@code @0}..{@code @6}); returns its exit code. */
    @Expression(name = FN_EXECUTE_SCRIPT, description = "Executes an included script with 7 arguments")
    public static int executeScript(@Nullable Object name, @Nullable Object arg0, @Nullable Object arg1,
            @Nullable Object arg2, @Nullable Object arg3, @Nullable Object arg4, @Nullable Object arg5,
    ...
    /** Executes an included script with 8 positional args ({@code @0}..{@code @7}); returns its exit code. */
    @Expression(name = FN_EXECUTE_SCRIPT, description = "Executes an included script with 8 arguments")
    public static int executeScript(@Nullable Object name, @Nullable Object arg0, @Nullable Object arg1,
            @Nullable Object arg2, @Nullable Object arg3, @Nullable Object arg4, @Nullable Object arg5,
    ...
    /** Executes an included script with 9 positional args ({@code @0}..{@code @8}); returns its exit code. */
    @Expression(name = FN_EXECUTE_SCRIPT, description = "Executes an included script with 9 arguments")
    public static int executeScript(@Nullable Object name, @Nullable Object arg0, @Nullable Object arg1,
            @Nullable Object arg2, @Nullable Object arg3, @Nullable Object arg4, @Nullable Object arg5,
    ...
    /** Executes an included script with 10 positional args ({@code @0}..{@code @9}); returns its exit code. */
    @Expression(name = FN_EXECUTE_SCRIPT, description = "Executes an included script with 10 arguments")
    public static int executeScript(@Nullable Object name, @Nullable Object arg0, @Nullable Object arg1,
            @Nullable Object arg2, @Nullable Object arg3, @Nullable Object arg4, @Nullable Object arg5,

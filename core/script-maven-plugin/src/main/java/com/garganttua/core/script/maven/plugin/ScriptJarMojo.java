...
public class ScriptJarMojo extends AbstractMojo {
    ...
    /** JAR entry path of the manifest, skipped when copying directory contents. */
     ...
     */
    // LooseCoupling: Manifest#getMainAttributes() returns the concrete java.util.jar.Attributes;
    // there is no narrower interface to depend on here.
     ...
     */
    private Set<String> autoDetectPackages() throws IOException {
